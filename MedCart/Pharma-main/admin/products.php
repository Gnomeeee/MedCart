        ...
        ?>
            ...
            <form action="products.php" method="POST">
                ...
                <div class="form-group">
                    ...
                    <input type="number" class="form-control" placeholder="<?php echo $data[0]['item_quantity'] ?>" name="quantity" min="1" max="10000">
                    <div class="form-text">please enter the quantity of the product in range(1-10000) .</div>
                </div>
                <div class="input-group mb-3 form-group">
