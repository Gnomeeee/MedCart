      ...
      <div class="d-flex justify-content-center flex-wrap">
        ...
        <div class="card m-4" style="width: 25rem;">
          ...
          <div class="card-body text-center">
            ...
            <a href="staff.php" class="btn btn-primary">Go to staff page</a>
          </div>
        </div>
        <div class="card m-4" style="width: 25rem;">
          <a href="admin.php">
          ...
          <div class="card-body text-center">
            ...
            <a href="rider.php" class="btn btn-primary">Go to rider page</a>
          </div>
        </div>
        <div class="card m-4" style="width: 25rem;">
          <a href="reviews.php">
          ...
          <div class="card-body text-center">
            ...
            <a href="reviews.php" class="btn btn-primary">Go to rider page</a>
          </div>
        </div>
        <div class="card m-4" style="width: 25rem;">
          <a href="../index.php">
          ...
          <div class="card-body text-center">
            ...
            <a href="../index.php" class="btn btn-primary">Go to Store page</a>
          </div>
        </div>
      </div>
    </main>
