                ...
                <table class="table table-striped table-sm">
                    ...
                    <?php
                        ...
                        <tr>
                            ...
                            <td><?php echo $data[$i]['rider_id']; ?></td>
                            <td><?php echo $data[$i]['user_address']; ?></td>
                            <td><?php echo $data[$i]['phone_number']; ?></td>
                            <?php
                            $status = strtolower($data[$i]['delivery_status']);
                            $color = match ($status) {
                                'pending' => 'orange',
                                'shipped' => 'blue',
                                'delivered' => 'green',
                            ...
                            <td>
                                <button type="button" class="btn btn-outline-danger">
                                    <a style="text-decoration: none; color:black;" href="orders.php?delete=<?= $data[$i]['order_id'] ?>">Delete</a>
                                </button>
                            </td>
                            <td>
                                <button type="button" class="btn btn-outline-info">
                                    <a style="text-decoration: none; color:black;" href="customers.php?id=<?= $data[$i]['user_id'] ?>">User details</a>
                                </button>
                            </td>
                            <td>
                                <button type="button" class="btn btn-outline-info">
                                    <a style="text-decoration: none; color:black;" href="products.php?id=<?= $data[$i]['item_id'] ?>">Product details</a>
                                </button>
                            </td>
                        </tr>
                        <?php } ?>
